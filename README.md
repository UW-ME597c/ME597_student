...
Open the [connectToUWtb4s.md](https://github.com/UW-ME597c/ME597_student/blob/main/connectToUWtb4s.md) markdown file in the main branch, and follow along. Read and follow each step carefully.
